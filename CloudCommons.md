...
# CloudCommons — Intelligent Infrastructure, Everywhere.
...
- CloudCommons specificiations are free to use with attribution. A Specification Branding License can be negotiated upon request.
